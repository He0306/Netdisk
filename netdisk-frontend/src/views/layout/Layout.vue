            ...
            <div class="header">
                ...
                <div class="right-panel">
                    ...
                    >
                        ...
                        <template #default>
                            <Uploader ref="uploadRef" @uploadCallback="uploadCallbackHandler"></Uploader>
                        </template>
                    </el-popover>

                    <div style="margin-left: 30px">
                        <span @click.stop="toggleDark()"></span>
                        <el-switch style="--el-switch-on-color: #13ce66; --el-switch-off-color: #bebebe"
                                   inline-prompt
                                   :active-icon="Moon"
                                   :inactive-icon="Sunny"
                                   v-model="isDark"/>
                        ...
                        <div class="user-info">
                            <div class="avatar">
                                <Avatar :userId="userInfo.userId"
                                        ...
                                        :timestamp="timestamp" :width="30"></Avatar>
                            </div>
            ...
            <div class="body">
                <div class="left-sider">
                    ...
                    <div class="menu-sub-list">
                        <div :class="['menu-item-sub',currentPath === sub.path ? 'active' : '']"
                             v-for="sub in currentMenu.children"
                             @click="jump(sub)">
                            <span :class="['iconfont','icon-' + sub.icon]"></span>
...
const addFile = (data) => {
    ...
    uploadRef.value.addFile(file, filePid)
}
